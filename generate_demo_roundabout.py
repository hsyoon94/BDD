...
def game_loop(args):
    ...
    while True:
        ...
        while termination is False:
            ...
            # print("world.sem_img", world.sem_img)
            # if sem_img_arr is not None:
            #     sem_img_arr = np.append(sem_img_arr, world.sem_img)
            #
            # print("sem_img_arr", sem_img_arr.shape)
            ...
            # print(sem_img_tmp.save_to_disk('/media/hsyoon/HS_VILAB1/IROS2020/tutorial/%.6d.png' % sem_img_tmp.frame, carla.ColorConverter.CityScapesPalette))
            ...
            # img_np = numpy.asarray(world.sem_img)
        ...
        if save is True:
            ...
            #         sem_img_arr = np.append(sem_img_arr, sem_img_arr[-(world.observation_space_dim + 1):-1])
            ...
            os.mkdir('/media/hsyoon/HS_VILAB1/BDD/expert_demo/%s_%s/' % (now_date, now_time))

            img_count = 0
            for image in sem_img_list:
                image.save_to_disk('/media/hsyoon/HS_VILAB1/BDD/expert_demo/%s_%s/%s.png' % (now_date, now_time, str(img_count)), carla.ColorConverter.CityScapesPalette)
            ...
            torch.save(data, '/media/hsyoon/HS_VILAB1/BDD/expert_demo/%s_%s/data-%s-%s.pt' % (now_date, now_time, args.filename, success_episode))
            print("=================================================================================")
